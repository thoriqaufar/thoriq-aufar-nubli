...
import thoriq from "../assets/FOTO.webp";
    ...
    return (
        ...
        >
            <div className="mt-8 lg:mt-20">
                ...
                <h2 className="hero-subheading bg-gradient-to-b from-pink-200 to-purple-300 bg-clip-text text-center text-2xl tracking-tighter text-transparent mt-2">
                    {PROFILE.role}
                </h2>
            </div>
            ...
            <a
                href="/Thoriq-Aufar-Nubli.pdf"
                target="_blank"
                rel="noopener noreferrer"
                download
                className="hero-btn mb-6 flex gap-1 rounded-full border border-pink-200/50 px-3"
            >
